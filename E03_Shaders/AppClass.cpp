...
void AppClass::InitVariables(void)
{
	...
	/// as soon as you disable VAO, VBO info dissappears
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, attributeCount * sizeof(glm::vec3), (GLvoid*)0);  /// Start position 0; get 3, skip 3, get 3, skip 3
	...
	/*
	// For Normals? attribute
	glEnableVertexAttribArray(2);
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_TRUE, attributeCount * sizeof(glm::vec3), (GLvoid*)(2 * sizeof(glm::vec3)));  /// stride: how many to skip
	*/
}
...
void AppClass::Display(void)
{
	...
	GLboolean Complimentary = glGetUniformLocation(m_uShaderProgramID, "Complimentary");
