...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_X * 30.f, ZERO_V3, -AXIS_Z);
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -15.f, ZERO_V3, AXIS_Y);
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -15.f, ZERO_V3, AXIS_Y);
		m_pCamera->SetNearFar(vector2(5.f, 50.f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -15.f, ZERO_V3, AXIS_Y);
